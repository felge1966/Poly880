...
;*************************************************************************
	...
	DW 	RETURN
;*************************************************************************
	DW	RETURN 		; Z22:	MAGNETBRNDAUSGABE GEWAEHLT
	DW	Z5Z
...
;*************************************************************************
	...
	DW	Z47Z
;*************************************************************************
	DW	RETURN 		; Z49: 	KOMMANDO PBRTEINGABE GEWAEHLT
	DW	Z5Z
...
;*************************************************************************
;
; EINGABE EINES REGISTERPAARNAMENS DURCH DIE HAXDEZIMALTASTATUR
;
Z2Z 	LD	(IY+PROZ),Z3
;*************************************************************************
;
; KORREKTUR DES REGISTERPARRNAMENS DURCH ERNEUTE EINGABE
;
Z3Z	CP	13
	JR	C,Z3ZM1
	XOR 	A
...
;*************************************************************************
;
; UEBERGANG ZUR DARSTELLUNG DES INHALTES DES SPEZIFIZIERTEN REGISTERPRARES
;
Z3E 	LD 	A,(IY+H2)
	CP 	9
	JP	NC,Z4AEM4
...
;*************************************************************************
;
; UEBERCfANG ZUR MODIFIKATION DES NAECHSTEN REGISTERPAARES, ABSPEICHERN
...
;*************************************************************************
;
; UEBERGANG ZUR PRUEFPUNKTEINGA$E NACH ERFOLGTER ADRESSEINGABE
;
Z9E 	LD 	HL,(HR1)
	LD 	(SYSP26),HL
	JR 	Z8E
...
;*************************************************************************
;
; AUSFUEHRUHG EINES SCHRITTES NACH EINGABE EINER ADRESSE
;
Z13E	LD 	HL,(HR1)
	LD 	(SYSP26),HL 	; PC
;*************************************************************************
...
;*************************************************************************
;
; UNTERPROGRAMM FUER DIE MAGNETBANDEINGASE
;
